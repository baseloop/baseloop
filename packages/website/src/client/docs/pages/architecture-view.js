...
export default class ArchitectureView extends React.PureComponent {
  render () {
    return (
      <>
        <h1>Architecture</h1>
        <p>Curabitur condimentum pellentesque nunc, vel ullamcorper magna condimentum vitae. Integer tincidunt ipsum
          ...
          tempus diam id massa ultricies ultrices.</p>
      </>
    )
  }
}

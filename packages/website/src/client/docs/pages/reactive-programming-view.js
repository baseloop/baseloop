...
export default class ReactiveProgrammingView extends React.PureComponent {
  render () {
    return (
      <>
        <h1>Reactive programming</h1>
        <p>Mauris ullamcorper erat nec odio facilisis porttitor vitae ac quam. Ut eu sollicitudin nibh. Donec vitae

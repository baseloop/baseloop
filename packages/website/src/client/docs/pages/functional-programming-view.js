...
export default class FunctionalProgrammingView extends React.PureComponent {
  render () {
    return (
      <>
        <h1>Functional programming</h1>
        <p>Suspendisse sollicitudin auctor tellus sit amet pellentesque. Phasellus fringilla non leo at efficitur.
